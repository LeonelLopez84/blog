    <form action="/admin/article/store" method="POST" class="w-full max-w-lg">
        @csrf
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <div class="w-full py-3 px-3 mb-6 md:mb-0">
                <label class="py-6 px-6" for=""><img wire:model="thumbnail" src="{{asset('images/'.$thumbnail)}}" alt=""></label>
            </div>
